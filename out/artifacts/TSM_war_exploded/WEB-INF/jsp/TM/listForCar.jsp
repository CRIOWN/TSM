    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'local', width: 180, title: '城市'},
                {field: 'number', title: '电话号码', minWidth: 100},
                {field: 'detail', width: 120, title: '描述', sort: true},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit')
            {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: 'gotoEditClient?id='+data.id,
                    end:function (){
                        table.reload('currentTableId')
                    }
                });
