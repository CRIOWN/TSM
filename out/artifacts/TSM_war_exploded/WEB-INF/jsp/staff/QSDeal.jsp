...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="edit">确认</a>
        ...
        table.render(
            {
                ...
                cols: [[
                    ...
                    {field: 'clientid', width: 110, title: '客户名',sort: true},
                    {field: 'startS', width: 110, title: '出发地', sort: true},
                    {field: 'endS', width: 110, title: '目的地',sort: true},
                    {field: 'sendtimeS', title: '发货时间', minWidth: 180,sort: true},
                    {field: 'recetimeS', title: '收货时间', minWidth: 180,sort: true},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit')
            {
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == 0) {
                            layer.msg("确认成功::" + data.id);
                            table.reload('currentTableId');

                        } else {
                            layer.msg("确认失败::" + data.id);
                        }
                        var iframeIndex = parent.layer.getFrameIndex(window.name);
                        parent.layer.close(iframeIndex);
                    }
